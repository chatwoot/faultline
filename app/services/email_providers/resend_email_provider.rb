  ...
  class ResendEmailProvider < BaseEmailProvider
    ...
    def self.send_verification_email(user)
      payload = {
        ...
        html: verification_email_html(user)
      }
    ...
    def self.send_workspace_invitation(invite)
      payload = {
        ...
        html: invitation_email_html(invite)
      }
    ...
    def self.send_email(payload)
      ...
      request['Authorization'] = "Bearer #{AppConfig.resend_api_key}"
      ...
      unless response.code.to_i.between?(200, 299)
        raise "Failed to send email via Resend: #{response.body}"
      end
